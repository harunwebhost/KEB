...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                 <li>
                                    <a href="<?php echo base_url() ?>index.php/admin/admin/course?type=form">Add</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() ?>index.php/admin/admin/course?type=view">All Course</a>
                                </li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Main Course<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url() ?>index.php/admin/admin/course?type=add_main">Add New</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() ?>index.php/admin/admin/course?type=view_main">All Main</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                 <li>
                                    <a href="<?php echo base_url() ?>index.php/admin/admin/enquiry">Add</a>
                                </li>
    ...
    <?php 
    $show_table=array('view_main_course.php','contact.php','course.php' );
    if(in_array($body,$show_table)){?>
